namespace Dejavu {
  ...
  //Seconde Act
    ...
    await ƒS.Character.show(characters.PIC,characters.PIC.pose.normal,ƒS.positionPercent(50, 90));
    await ƒS.update(1);
    ...
    switch (choiceDraw) {
      case choicesDraw.portrait:
        ...
        let choiceCompliment = await ƒS.Menu.getInput(choicesCompliment, "choices");
